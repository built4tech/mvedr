...
$eventHint.add( '4697', 'SECURITY: New service installed' )
$eventHint.add( '4698', 'SECURITY: Scheduled task created' )
$eventHint.add( '4699', 'SECURITY: Scheduled task deleted' )
$eventHint.add( '4700', 'SECURITY: Scheduled task enabled' )
$eventHint.add( '4701', 'SECURITY: Scheduled task disabled' )
